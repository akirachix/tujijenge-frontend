...
//     // Arsu Added this
//     console.log('Communities mapping:', communities);
//     console.log('Example order community id:', data.length > 0 ? data[0].community : 'no data');
...
/**
 * Fetch orders and enrich them with community names, product names, customer locations.
 * @param {Object} options
 * @param {number|null} options.groupId - Optional group filter.
 ...
 * @param {boolean} options.groupByDateAndCommunity - Whether to group results.
 * @param {Object} options.communities - Lookup object { [communityId]: communityName }
 * @param {Object} options.customers - Lookup object for customers.
 * @param {Object} options.products - Lookup object for products.
 * @returns {Promise<{ paginatedOrders: Array, total: number }>}
 */
export const fetchOrders = async ({
  groupId,
  searchQuery,
  ...
  try {
    ...
    // Debug: log keys and entries of communities
